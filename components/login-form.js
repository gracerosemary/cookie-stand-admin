...
export default function LoginForm( {onSubmit}) {
    ...
    return (
        <form onSubmit={submitHandler} className="p-8 flex flex-col mt-24 ml-48 border-4 border-green-400 bg-green-200 text-center w-3/4 uppercase rounded-xl font-bold text-xl">
